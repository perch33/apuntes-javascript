...
//numbers.splice(2,2,10 ,23, 54); si b es un valor distinto de 0 elimina el numero de valores que indiquemos en b y añade los valores de items a partir de su posicion a
//console.log(numbers);
//numbers.splice(2,0,10 ,23, 54); si queremos añadir elementos solo debemos de agregar en el item B el valor de 0 a partir de la posicion A
...
// console.log(numbers);
// console.log(newNumbers); hace una copia del original
...
// let newNumbers = numbers.slice(2, 4); el item B determina hasta donde va a contar
